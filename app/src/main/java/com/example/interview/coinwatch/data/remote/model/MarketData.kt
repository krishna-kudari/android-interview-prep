...
data class MarketData(
    ...
    val maxSupply: Int,
    @SerializedName("max_supply_infinite")
    val maxSupplyInfinite: Boolean,
    @SerializedName("mcap_to_tvl_ratio")
    val mcapToTvlRatio: Any,
    @SerializedName("outstanding_supply")
    val outstandingSupply: Any,
    @SerializedName("outstanding_token_value_usd")
    val outstandingTokenValueUsd: Any,
    ...
    val priceChangePercentage24hInCurrency: PriceChangePercentage1hInCurrency,
